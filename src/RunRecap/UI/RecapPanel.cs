...
internal static class RecapPanel
{
                                     ...
                                     Action onClose, Action<PanelHandle> onSave)
    {
        ...
        var root = new Control { Name = "RunRecap", MouseFilter = Control.MouseFilterEnum.Stop };
    ...
    /// <summary>
    /// The game's top bar across the screen: "Run recap · Victory", floor, time, ascension and team damage with the
                                  ...
                                  Vector2 stage)
    {
        ...
        title.AddChild(Kit.Center(k.Strong("Run recap · ", 30)));
